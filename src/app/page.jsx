...
export default function Home() {
  return (
    <><main className="flex flex-col items-center justify-between px-10 xl:px-56 2xl:px-[350px] lg:px-24 max-w-[1538px] mx-auto">
      ...
      <nav className="flex items-center justify-between w-full bg-white py-4">
        <Image src="/mondly/images/logo-indico.png" alt="logo indico" width={154} height={47} />
      ...
      <div className="flex flex-col gap-5 items-center justify-between w-full bg-white py-1">
        ...
        <div className="flex flex-col w-full">
          <p className="text-[22px] font-normal text-[#2B2B2B] ">Exclusivo para Indico</p>
  ...
  <Link
    ...
    href="https://shop.mondly.com/order/checkout.php?CLEAN_CART=1&CURRENCY=BRL&CART=1&CARD=2&SHORT_FORM=1&ADDITIONAL_B2B_COMPANY_REF=36830%242aO5kx_PQLEAkEGN9i5_NKHyVwIfJkZO&PRODS=46420733&QTY=1&PRICES46420733%5BBRL%5D=25.13&PHASH=sha3-256.780e60f082aeacb3f1ca7e81a1a8ce02fdaba3ce71be7433f78412de85be5b1d"
    target="_blank"
  >
  ...
  <Link
    className="w-full sm:w-auto h-12 text-left"
    href="https://shop.mondly.com/order/checkout.php?CLEAN_CART=1&CURRENCY=BRL&CART=1&CARD=2&SHORT_FORM=1&ADDITIONAL_B2B_COMPANY_REF=36829%24HqqWIoSrXbBuWjhotPq12D8BPbXuBPCP&PRODS=46453293&QTY=1&PRICES46453293%5BBRL%5D=98.34&PHASH=sha3-256.16302d851c8d6e245cf694c9b1f3eb8e17773be864823b0a912af3abbd384cee"
    target="_blank"
  >
    <Button className="bg-[#3D75DB] text-white text-sm font-bold px-6 py-6 w-full sm:w-auto">
      ...
      <div className="w-full flex-wrap lg:flex-nowrap flex items-center justify-between md:justify-center py-2">
        ...
        <div className="flex items-center justify-center 2xl:w-[300px] xl:w-[380px] lg:w-[350px] w-auto">
          <p className="text-text-a 2xl:text-[29px] xl:text-[25px] text-[17px]  leading-7 font-normal text-start mt-6">
            Clientes Indico têm acesso a um desconto exclusivo no Mondly by Pearson. Agora você pode aprender inglês,espanhol, francês e muitos outros idiomas com lições rápidas, interativas e acessíveis.</p>
        </div>
      ...
      <div className="w-full mb-5 mt-14 flex-wrap 2xl:flex-nowrap xl:flex-nowrap lg:flex-nowrap flex items-start justify-center gap-10">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex-wrap 2xl:flex-nowrap xl:flex-nowrap lg:flex-nowrap flex 2xl:items-start items-center justify-center gap-4">
            <Image src="/mondly/images/icone1.png" alt="icone" width={86} height={87} />
